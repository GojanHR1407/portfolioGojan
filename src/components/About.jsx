    ...
    return (
        <section className="about container">
                ...
                <div className="about__text" id="skills" data-aos="fade-right">
                    ...
                    <p className="about__paragraph">Por la parte BackEnd: <FontAwesomeIcon icon={faPython} style={{color: '#306998'}} /> Python, lenguaje de consultas <FontAwesomeIcon icon={faCoins} style={{color: '#AAAAAA'}} /> SQL, tengo algunos conocimetos sobre la metodología de Scrum y sobre <FontAwesomeIcon icon={faGitAlt} style={{color: '#BD2C00'}} /> Git. Actualmente estoy en el aprendizaje de .Net, <FontAwesomeIcon icon={faDocker} style={{color: '#0DB7ED'}}/> Docker y <FontAwesomeIcon icon={faJava} style={{color: '#BD2C00'}}/> Java con Springboot.</p>
                </div>
